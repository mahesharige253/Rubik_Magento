...
return [
    'modules' => [
        ...
        'Bat_AdminCss' => 1,
        'Bat_Attributes' => 1,
        'Navigate_BannerSlider' => 1,
        'Bat_BestSellers' => 1,
        'Bat_CatalogGraphQl' => 1,
        'Bat_Cms' => 1,
        'Bat_Customer' => 1,
        'Bat_CustomerAddressGraphQl' => 1,
        'Bat_CustomerBalanceGraphQl' => 1,
        'Bat_CustomerConsentForm' => 1,
        'Bat_CustomerGraphQl' => 1,
        'Bat_GetCartGraphQl' => 1,
        'Bat_Kakao' => 1,
        'Bat_NewProduct' => 1,
        'Bat_OrderProducts' => 1,
        'Bat_PriceTagsGraphQl' => 1,
        'Bat_QuoteGraphQl' => 1,
        'Bat_VirtualBank' => 1,
        'Fastly_Cdn' => 1,
        'Bat_BannerApi' => 1,
